  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
        ...
        {/* Tabs */}
        {!hideTabs && (
          <div className="flex overflow-x-auto border-b border-gray-100 bg-white rounded-t-2xl">
        ...
        {/* Table Toolbar */}
        <div className={`p-4 border-b border-gray-100 flex flex-col sm:flex-row gap-4 justify-between items-center bg-gray-50/50 ${hideTabs ? 'rounded-t-2xl' : ''}`}>
        ...
        <div className="p-4 sm:p-6 bg-gray-50/30 rounded-b-2xl">
            ...
            {loading ? (
              ...
              filteredBookings.map((booking, i) => (
                <motion.div 
                  ...
                  key={booking.id}
                  className={`relative rounded-2xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 group ${getCardStyle(booking.status)}`}
                  style={{ zIndex: activeDropdownId === booking.id ? 40 : 1 }}
                >
                    ...
                    <div className="relative">
                      ...
                      <AnimatePresence>
                        {activeDropdownId === booking.id && (
                          <div className="absolute right-0 mt-1 w-48 bg-white border border-gray-150 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] z-50 py-2 text-left text-xs font-bold text-gray-750">
                            <button 
